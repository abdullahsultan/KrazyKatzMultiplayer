...
AKrazyKatsMutiplayerHud::AKrazyKatsMutiplayerHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void AKrazyKatsMutiplayerHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if (bWantHUD == true)
	{
		...
		AKrazyKatsMutiplayerPawn* Vehicle = Cast<AKrazyKatsMutiplayerPawn>(GetOwningPawn());
